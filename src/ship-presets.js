export const SHIP_PRESETS = {
  ...
  "x-wing":           { yaw: -Math.PI,   scale: 0.07, offset: [0, 0.00, 0], shipRadius: 2.5, name: "X-Wing" },
  "spaceship_rescue": { yaw: -Math.PI/2, scale: 2.55, offset: [0, 0.00, 0], shipRadius: 1.5, name: "Spaceship Rescue" },
